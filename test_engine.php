...
class MockToolRepo implements ToolRepositoryInterface {
    ...
    public function decrement_likes( $id ) { return 0; }
    public function increment_favorites( $id ) { return 0; }
    public function decrement_favorites( $id ) { return 0; }
    public function increment_reports( $id ) {}
    public function decrement_reports( $id ) { return 0; }
